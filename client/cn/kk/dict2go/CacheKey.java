...
public class CacheKey
{
  ...
  public int write(byte[] realIndexCache, int realOffset)
  {
    ...
    System.arraycopy(Dictionary.INDEX_CACHE_DATA, this.offset + CacheKey.KEY_LENGTH, realIndexCache, realOffset
        + this.keyLength, 4);
  ...
  public final static int binarySearch(final IndexKey inputKey)
  {
    ...
    while (low <= high)
    {
      ...
      // inputKey.keyLength));
      final int cmp =
          ClientHelper.compare(Dictionary.INDEX_CACHE_DATA, midVal.offset, midVal.keyLength, inputKey.key, 0,
              inputKey.keyLength);
