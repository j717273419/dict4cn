 ...
 * 
 * <p>
 * The decompression requires large amounts of memory. Thus you should call the {@link #close() close()} method as soon
 * as possible, to force <tt>CBZip2InputStream</tt> to release the allocated memory. See {@link CBZip2OutputStream
 * CBZip2OutputStream} for information about memory usage.
 * </p>
 * 
 * <p>
 * <tt>CBZip2InputStream</tt> reads bytes from the compressed source stream via the single byte
 * {@link java.io.InputStream#read() read()} method exclusively. Thus you should consider to use a buffered source
 * stream.
 * </p>
 * 
 * <p>
...
public class CBZip2InputStream extends InputStream implements BZip2Constants {
     ...
     * 
     * <p>
     * Although BZip2 headers are marked with the magic <tt>"Bz"</tt> this constructor expects the next byte in the
    ...
    private void getAndMoveToFrontDecode() throws IOException {
        ...
        while (nextSym != eob) {
            if ((nextSym == RUNA) || (nextSym == RUNB)) {
                ...
                /*
                 * This loop is hammered during decompression, hence avoid native method call overhead of
