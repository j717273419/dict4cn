...
public class ChineseHelperTest {
    ...
    public void testToSimplifiedChineseByteBufferCorrupted() {
        ...
        System.out.println(ArrayHelper.toString(bb));
        System.out
                .println("东斯拉夫人（俄文：Восточные славян）原属于斯拉夫语族群，后来转变成俄罗斯人、乌克兰人和白俄罗斯人。俄国和乌克兰国内的人国籍繁多促使歷史和起源更加复杂。的首都埃里温，其因基督教的圣经《创世纪》一篇中记载，着名的诺亚方舟在大洪水后，最后停泊的地方就在亚拉拉特山上，因此也使得亚拉拉特山在欧洲、西亚的基督教世界远近驰名。万只。拥有的路");
        System.out.println(ArrayHelper.toString(bb));
        assertEquals(
