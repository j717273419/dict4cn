...
public class ChineseHelperTest {
    ...
    private String testZh4 = "'''首都'''，又称'''国都'''，以[[现代]][[政治]]角度而言，通常指一个[[国家]]的[[中央政府]]所在的首要[[城市]]<ref>{{cite book|title=国语辞典（节本）|author=台湾商务印书馆编审部|publisher=[[台湾商务印书馆]]|origyear=1937|origmonth=3|year=1976|edition =台三版|quote =国都：一国中央政府之所在地|pages =369}}</ref><ref>{{cite web|title=中华人民共和国行政区划|quote=在歷史上和习惯上，各省级行政区都有简称。省级人民政府驻地称省会（首府），中央人民政府所在地是首都。北京就是中国的首都。|url=http://www.gov.cn/test/2005-06/15/content_18253.htm|date=2005-06-15|accessdate=2009-08-13|publisher=中国政府网}}</ref>，也是[[政治]]活动的中心城市、各类[[国家]]级机关集中驻扎地、国家[[主权]]的象征城市。在大部分国家，首都是国家最大的城市，如[[法国]][[巴黎]]、[[墨西哥]][[墨西哥城]]等；大部份的国家也未在宪法和法律内订定首都地点<ref>{{cite news|title=近日修改教科书　游揆：中华民国首都在台北市|date=2002/03/29|url=http://www.nownews.com/2002/03/29/328-1282773.htm|publisher=Ettoday|accessdate=2010-12-15|author=林献堂|quote=陈定南沒有明确回答，只说世界大部分国家都沒有在宪法、法律订定首都地点，中央机关在那里，首都就在那}}</ref>，而在部分国家，政治中心与经济中心分离，例如美国首都[[华盛顿哥伦比亚特区]]、土耳其首都[[安卡拉]]等。有时一个国家有多个首都，如'''行政首都'''、'''司法首都'''，分别是该国的行政与司法中心。";
    ...
    public void testToSimplifiedChineseByteBufferCorrupted() {
        ...
        System.out.println(ArrayHelper.toString(bb));
        System.out.println("东斯拉夫人（俄文：Восточные славян）原属于斯拉夫语族群，后来转变成俄罗斯人、乌克兰人和白俄罗斯人。俄国和乌克兰国内的人国籍繁多促使歷史和起源更加复杂。的首都埃里温，其因基督教的圣经《创世纪》一篇中记载，着名的诺亚方舟在大洪水后，最后停泊的地方就在亚拉拉特山上，因此也使得亚拉拉特山在欧洲、西亚的基督教世界远近驰名。万只。拥有的路");
        System.out.println(ArrayHelper.toString(bb));
        assertEquals(
    ...
    public void testToSimplifiedChineseString() {
        ...
        assertEquals("台湾", ChineseHelper.toSimplifiedChinese("臺湾"));
    }
