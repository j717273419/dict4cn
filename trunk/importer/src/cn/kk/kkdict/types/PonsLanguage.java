...
public enum PonsLanguage {
  ...
  private PonsLanguage(final Language lng, final String key, final String name) {
    this.lng = lng;
    this.key = key;
    this.name = name;
  }
  ...
  static {
    ...
    for (final PonsLanguage l : PonsLanguage.values()) {
      PonsLanguage.LNG_MAPPING.put(l.lng, l);
    }
  }
}
