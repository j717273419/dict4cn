...
public class Translation
{
  ...
  private Translation(long trlId, byte[] srcKey, short srcLng, short tgtLng, String srcVal, String tgtVal,
      byte srcGender, byte srcCategory, byte srcType, byte srcUsage)
  {
    this.trlId = trlId;
    this.srcLng = srcLng;
    this.tgtLng = tgtLng;
  ...
  Translation(long trlId, String srcKeyHex, short srcLng, short tgtLng, String srcVal, String tgtVal, byte srcGender,
      byte srcCategory, byte srcType, byte srcUsage)
  {
    this(trlId, ArrayHelper.fromHex(srcKeyHex), srcLng, tgtLng, srcVal, tgtVal, srcGender, srcCategory, srcType,
        srcUsage);
  }
  ...
  public static Translation from(short srcLngId, String srcVal, short tgtLngId, String tgtVal) throws IOException
  {
    ...
    Translation trl =
        new Translation(SuperIndexGenerator.createPhonetecIdx(srcValCleaned), srcLngId, tgtLngId, srcValCleaned,
            tgtValCleaned);
    return trl;
  }
  ...
  {
    return "Translation [srcLng=" + this.srcLng + ", tgtLng=" + this.tgtLng + ", srcVal=" + this.srcVal + ", tgtVal="
        + this.tgtVal + "]";
  }
