...
public class WikiDictGeoLocationCorrectorTest {
    ...
    public void testCorrectGeoLocation() {
        ...
        assertEquals("de═Mexiko‹位19.375,-99.125", ArrayHelper.toString(bb));
        ...
        WikiDictGeoLocationCorrector.correctGeoLocation(row);
        // System.out.println(ArrayHelper.toString(bb));
        assertEquals("zh═道谷‹位38.75,-87.875", ArrayHelper.toString(bb));
        ...
        WikiDictGeoLocationCorrector.correctGeoLocation(row);
        // System.out.println(ArrayHelper.toString(bb));
        assertEquals("de═Pinto (Spanien)‹位40.25,3.75", ArrayHelper.toString(bb));
